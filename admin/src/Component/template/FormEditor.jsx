...
const FormEditor = (props) => {    
    const {form,onItemChange,onItemRemove,onItemAdd,onFormSectionEdit,title} = props
    return <Paper sx={{ marginTop: 2, padding: 2 }}>
        <Toolbar sx={{ margin: "0 !important", padding: "0 !important", minHeight: "0 !important" }}>
            <Typography sx={{ flex: '1 1 100%' }} component="div" >{title?title:"Form Editor"}</Typography>
