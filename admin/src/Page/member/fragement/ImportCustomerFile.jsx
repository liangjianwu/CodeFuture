...
import { Container, CssBaseline,  Button,  Grid, Box,  Typography, Alert,  Backdrop } from '@mui/material';
...
const ImportCustomerFile = (props) => {
    ...
    return (
        ...
        <Container component="main" maxWidth="sm">
            ...
            <Box sx={{ marginTop: 12, width: '350px !important', display: 'flex', flexDirection: 'column', alignItems: 'left', }}>
                <Typography component="h1" variant="h5">Import customers from file</Typography>
                ...
                <Box fullwidth sx={{ mt: 2, }}>
                    ...
                    If the header's value is in (fistname and lastname or name, birthday, email, phone, address, city, province, country, postcode),
                    the column will be read into the corresponding field, else the column will be read into the extend field.<br></br>
                    If email or phone has existed in your customers, the customer will be not imported again
                </Box>
                ...
                <Grid container mt={2} spacing={2}>
                    ...
                    <Grid item xs={4}>
                        <Uploady
                            destination={apis.uploadCustomers(getUserSession(), props.groupid)}>
                            <LogProgress />
                            <DivUploadButton />
                        </Uploady>
                    </Grid>
