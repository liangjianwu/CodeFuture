                ...
                <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }} autoComplete="off">
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={12}>
                            <TextField defaultValue={data?.type} name="type" required fullWidth id="type" label="Balance Type"
                                error={fieldErrors && fieldErrors.type ? true : false}
                                helperText={fieldErrors && fieldErrors.type ? fieldErrors.type : ''}
                                autoFocus />
                        </Grid>
                        <Grid item xs={12} sm={12}>
                            <TextField defaultValue={data?.level} type="number" name="level" fullWidth id="level" label="Privillege"
                                error={fieldErrors && fieldErrors.level ? true : false}
                                helperText={fieldErrors && fieldErrors.level ? fieldErrors.level : ''}
                                autoFocus />
                        </Grid>                               
                    </Grid>
