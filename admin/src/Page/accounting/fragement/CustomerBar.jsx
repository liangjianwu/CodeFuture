import { Button, Toolbar, Typography, Tooltip, Menu, Box, InputBase, Divider, IconButton, Paper, Stack, MenuItem, ListItemIcon, ListItemText, TextField } from "@mui/material"
        ...
        props.children ?
            ...
            <Paper sx={{ marginBottom: 2 }}>
                <Toolbar style={{ paddingLeft: 2 }}>
                    ...
                    <Typography sx={{ flex: '1 1 100%' }} variant="h6" component="div" > </Typography>
                    {props.onSwitch && <Button onClick={props.onSwitch}>Switch</Button>}
                    <Typography sx={{ flex: '1 1 1%' }} variant="h6" component="div" > </Typography>
                    <Tooltip title="Filter">
                        <IconButton
                            onClick={handleClick}
                            size="small"
                    ...
                    >
                        {props.onFilterByGroup && <MenuItem onClick={props.onFilterByGroup}>
                            Filte by group
                        </MenuItem>}
                        {props.onFilterByTag && <MenuItem onClick={props.onFilterByTag}>
                            Tag
                        </MenuItem>}
