...
const Refund = (props) => {    
    ...
    const [date,setDate] = useState(props.item && props.item.order_date.substring(0,10))
    ...
    const handleAmountChange = (e) => {
        ...
        props.item.product_id > 0 && product && product.minutes>0 && setCount((Number(e.target.value)*1.0/Number(product.price)*Number(product.minutes)).toFixed(2))
    }
    const handleCountChange = (e)=>{
        setCount(e.target.value)
        props.item.product_id > 0 && product && product.minutes>0 && setAmount((Number(e.target.value)*1.0/Number(product.minutes)*Number(product.price)).toFixed(2))
    }
