...
const MemberOptButton = (props) => {
    ...
    return (<><IconButton onClick={handleClick}
        ...
        >
            <MenuItem onClick={()=>{props.onCharge && props.onCharge(props.id,props.index)}}>
                <ListItemIcon>
                    <ContentPasteGo fontSize="small" />
                </ListItemIcon>
                Charge
            </MenuItem>
            <MenuItem onClick={()=>{props.onRecharge && props.onRecharge(props.id,props.index)}}>
                <ListItemIcon>
...
export default MemberOptButton