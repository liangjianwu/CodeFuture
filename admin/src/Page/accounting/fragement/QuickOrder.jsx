...
const QuickOrder = (props) => {
    ...
    const handleAddOrder = () => {
        setError()        
        if(order.product && order.customer && order.count>0 && order.date && order.date.length === 10) {
    ...
    return <Grid container spacing={2}>
        ...
        <Grid item lg={3}>
            <Button variants="outlined" onClick={()=>{navigate('/accounting/quickcharge')}} >Switch to group charge</Button>
        </Grid>
    </Grid>
}
